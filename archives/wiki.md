...
本博客使用的系统是由[Jak Wings](http://likelikeslike.com)完成的静态博客系统Wiedersehen。Wiedersehen是一款开源博客系统，源代码请戳[这里][Git]。原版的示例页面请见[这里][demo]，而本博客使用的代码部分细节已由我优化。我会在近日将本博客以及本站完全开源，敬请期待。
...
1.  下载源代码
    ...
    原版的下载地址在本文最前面。由于我还没弄明白GitHub的使用方法，如果你需要我的修改版，请在下面留言。
...
1. 修改样式
    ...
    本博客的样式使用的是[bootstrap]()，不建议直接修改bootstrap.css，自定义的地方主要在   `css/custom.css` ，如果你熟悉css的编写，修改应该很方便。
